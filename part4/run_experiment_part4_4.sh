...
# Set up logging
mkdir -p ../data/part4/task4_4
exec > >(tee -a ../data/part4/task4_4/experiment_log.txt) 2>&1
...
RESULTS_DIR="../data/part4/task4_4"
...
for i in $(seq 1 $NUM_RUNS); do
  ...
  gcloud compute ssh --ssh-key-file ~/.ssh/cloud-computing "ubuntu@$CLIENT_MEASURE_NODE_NAME" --zone europe-west1-b \
    ...
    # Run benchmark
    ./mcperf -s $MEMCACHED_IP -a $INTERNAL_AGENT_IP --noload -T 8 -C 8 -D 4 -Q 1000 -c 8 -t 840 --qps_interval 4 --qps_min 5000 --qps_max 180000 --qps_seed 2333
    " > "$RESULTS_FILE" 2>&1 &
